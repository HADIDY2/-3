...
greting = [
    "منور يا عسل", "نورت وردة",
    "أنت في المكان المناسب لتطوير مهاراتك ومشاركة اهتماماتك!",
    "نرحب بك كأحد أفراد عائلتنا الجميلة!",
    "استعد لتجربة تفاعلية لا تنسى معنا!", "دخلت الحكومة",
    "القمرر دخل روم وسعوو", "منور يزلمتي",
    "نحن في انتظارك لنشارك معك لحظات فريدة وممتعة!",
    "دكتور عالجني فراك غالي موتني", "ارحبببب",
    "نرحب بك في مجتمعنا المفعم بالتعاون والتنوع!", "اجا الضابطط",
    "دخلل احلى واحد غمضو عيونكم", "وسعع جانا شيخخ", "دخللل الطيار",
    "نحن في انتظار إضافتك الثرية والمميزة للمحادثات!",
    "مرحبًا بك في مجتمع العطاء والاحترام المتبادل!", "كمية العسل دخلت",
    "دخل القيااااده واحد على واحد"
]
name_ad = ["E30_Gpower", "__unknwn__", "Mr_Black.7"]
...
class MyBot(BaseBot):
  dancs = [
      ...
      "idle-lookup", "idle-hero", "emote-wings", "emote-hello", "dance-weird",
      ...
      "idle_singing", "emote-Rest", "emote-zero gavity", "emote-LEVITATE",
      "emote-FAINT", "idle-Attentive", "emote-NAUGHTY", "dance-PROPOSING",
      "dance-FALL", "idle-Rest", "emote-Confusion", "dance-SAY SO DANCE",
      "emote-hello", "dance-weird", "emote-superpose", "idle-lookup",
      "idle-hero", "emote-wings", "emote-laughing", "emote-kiss", "emote-wave",
      "emote-hearteyes", "emote-theatrical", "emote-teleporting", "emote-slap",
      "emote-ropepull", "emote-think", "emote-hot", "dance-shoppingcart",
      "emote-greedy", "emote-frustrated", "emote-float", "emote-baseball",
      "emote-yes", "idle_singing", "idle-floorsleeping", "idle-enthusiastic",
      "emote-confused", "emoji-celebrate", "emote-no", "emote-swordfight",
      "emote-shy", "dance-tiktok2", "emote-model", "emote-charging",
      "emote-snake", "dance-russian", "emote-sad", "emote-lust",
      "emoji-cursing", "emoji-flex", "emoji-gagging", "dance-tiktok8",
      "dance-blackpink", "dance-pennywise", "emote-bow", "emote-curtsy",
      "emote-snowball", "emote-snowangel", "emote-telekinesis", "emote-maniac",
      "emote-energyball", "emote-frog", "emote-cute", "dance-tiktok9",
      "dance-tiktok10", "emote-pose7", "emote-pose8", "emote-Guitar",
      "idle-dance-casual", "emote-pose1", "emote-pose3", "emote-pose5",
      "emote-laughing", "dance-tiktok8", "dance-blackpink", "dance-tiktok2",
      "dance-pennywise", "emote-hello", "dance-weird", "emote-superpose",
      "idle-lookup", "idle-hero", "emote-Wings", "dance-macarena",
      "emote-hello", "dance-weird", "emote-superpose", "idle-lookup",
      "idle-hero", "idle-loop-sitfloor", "emote-tired", "emoji-thumbsup",
      ...
      "emote-think", "emote-hot", "dance-shoppingcart", "emote-greedy",
      "emote-frustrated", "emote-float", "emote-baseball", "emote-yes",
      "idle_singing", "idle-floorsleeping", "idle-enthusiastic",
      "emote-confused", "emoji-celebrate", "emote-no", "emote-swordfight",
      "emote-shy", "dance-tiktok2", "emote-model", "emote-charging",
      "emote-snake", "dance-russian", "emote-sad", "emote-lust",
      "emoji-cursing", "emoji-flex", "emoji-gagging", "dance-tiktok8",
      ...
      "emote-Relaxing", "emote-model", "emote-fashionista", "emote-gravity",
      "emote-zombierun", "emoji-ceilebrate", "emoji-floss", "emote-Relaxing ",
      "emote-punkguitar", "dance-tiktok9", "dance-weird", "emote-punkguitar",
      "idle-uwu"
      "emote-bow", "emote-cursty", "dance-breakdance", "emote-creepycute",
      "emote-headblowup", "idle-guitar", "emote-wins", "dance-SAY SO DANCE ",
      "idle-floorsleeping", "idle-enthusiastic", "emote-confused",
      "emoji-celebrate", "emote-no", "emote-swordfight", "emote-BUMMED",
      "emote-shy", "dance-tiktok2", "emote-model", "emote-charging",
      "emote-snake", "dance-russian", "emote-sad", "emote-lust",
      "emoji-cursing", "emoji-flex", "emoji-gagging", "dance-tiktok8",
      "dance-blackpink", "dance-pennywise", "emote-bow", "emote-curtsy",
      ...
      "dance-tiktok10", "emote-pose7", "emote-pose8", "idle-dance-casual",
      "emote-pose1", "emote-pose3", "emote-pose5", "emote-cutey",
      "emote-Relaxing", "emote-model", "emote-cursty", "emote-tired",
      "idle-loop-sitfloor", "emote-tired", "emoji-thumbsup", "emoji-angry",
      "dance-macarena", "emote-hello", "dance-weird", "emote-superpose",
      "idle-lookup", "idle-hero", "emote-wings", "emote-laughing",
      "emote-kiss", "emote-wave", "emote-hearteyes", "emote-theatrical",
      "emote-teleporting", "emote-slap", "emote-ropepull", "emote-think",
      "emote-hot", "dance-shoppingcart", "emote-greedy", "emote-frustrated",
      "emote-float", "emote-baseball", "emote-yes", "idle_singing",
      "idle-floorsleeping", "idle-enthusiastic", "emote-confused",
      "emoji-celebrate", "emote-no", "emote-swordfight", "emote-shy",
      "dance-tiktok2", "emote-model", "emote-charging", "emote-snake",
      "dance-russian", "emote-sad", "emote-lust", "emoji-cursing",
      "emoji-flex", "emoji-gagging", "dance-tiktok8", "dance-blackpink",
      "dance-pennywise", "emote-bow", "emote-curtsy", "emote-snowball",
      "emote-snowangel", "emote-telekinesis", "emote-maniac",
      "emote-energyball", "emote-frog", "emote-cute", "dance-tiktok9",
      "dance-tiktok10", "emote-pose7", "emote-pose8", "idle-dance-casual",
      "emote-pose1", "emote-pose3", "emote-pose5", "emote-cutey",
      "emote-Relaxing", "emote-model", "emote-cursty,", "emote-kiss",
      "emote-wave", "emote-hearteyes", "emote-theatrical", "emote-teleporting",
      "emote-slap", "emote-ropepull", "emote-think", "emote-hot",
      "dance-shoppingcart", "emote-greedy", "idle-loop-sitfloor",
      "emote-tired", "emoji-thumbsup", "emoji-angry", "dance-macarena",
      "emote-hello", "dance-weird", "emote-superpose", "idle-lookup",
      "idle-hero", "emote-wings", "emote-laughing", "emote-kiss", "emote-wave",
      "emote-hearteyes", "emote-theatrical", "emote-teleporting", "emote-slap",
      "emote-ropepull", "emote-think", "emote-hot", "dance-shoppingcart",
      ...
      "dance-tiktok10", "emote-pose7", "emote-pose8", "idle-dance-casual",
      "emote-pose1", "emote-pose3", "emote-pose5", "emote-cutey",
      "emote-Relaxing", "emote-model", "emote-cursty", "emote-fashionista",
      "emote-frustrated", "emote-float", "emote-baseball", "emote-yes",
      "idle_singing", "idle-floorsleeping", "idle-enthusiastic",
      "emote-confused", "emoji-celebrate", "emote-no", "emote-swordfight",
      "emote-shy", "dance-tiktok2", "emote-model", "emote-charging",
      ...
      "emoji-cursing", "emoji-flex", "emoji-gagging", "dance-tiktok8",
      "dance-blackpink", "dance-pennywise", "emote-bow", "emote-curtsy",
      "dance-breakdance", "emote-snowball", "emote-snowangel",
      "emote-telekinesis", "emote-maniac", "emote-energyball", "emote-frog",
      "emote-cute", "dance-tiktok9", "dance-tiktok10", "emote-pose7",
      "emote-pose8", "idle-dance-casual", "emote-pose1", "emote-pose3",
  ...
  async def on_start(self, SessionMetadata: SessionMetadata) -> None:
    try:
      await self.highrise.walk_to(Position(0, 18, 1, "FrontRight"))
      # await self.highrise.chat("وسع وسع أنا جيييييييييييت")
      await self.highrise.chat("hi i am here")
  ...
  async def teleport_user_next_to(self, target_username: str,
   ...
   # await self.highrise.chat(f"ولكم...رقصني-طلـعني-نـزلني-وقت موتي-وقت زواجي-زوجني-حيوان جماد-ازياء-نسبة انوثتي👸-نسبة نفاقي-نسبة نجاحي-نسبة قي🏳️‍🌈-عمري الكوني-نسبة حبي-نسبة رجولتي🤵-نسبة جمالي-نسبة كرهي-(1..2..3..4..5)-قعدني- طـيرني,  {user.username}!")
   ...
   # await self.highrise.chat(f"ولكم🤍استمتع بوقتك يحلو ولا تنسى تتبرعلنا بالحصالة ك دعم الناحب,  {user.username}!")
  ...
  async def on_chat(self, user: User, message: str) -> None:
    if message.startswith("بحبك"):
      await self.highrise.react("heart", user.id)

    async def on_whisper(self, user: User, message: str) -> None:
      """On a received room whisper."""
      if message.startswith('ارقghfhfgص') and user.username == "Mr_Black.7":
        try:
          xxx = message[2:]
      ...
      if message.startswith("ريست") and user.username == "Mr_Black.7":
        await self.highrise.send_emote("sit-idle-cute")
        await self.highrise.chat("يا حرام عندي ريست وانت ما عندك😂🙌")

    if message.startswith("بحبك"):
      await self.highrise.react("wink", user.id)
      await self.highrise.chat(f" خذ قلبي❤️ {user.username}")

    if message.startswith("I Love you"):
      await self.highrise.react("wink", user.id)
      await self.highrise.chat(f"❤️ {user.username}")
    
    elif "رقصني" in message:
      await self.highrise.chat(f"انا الي برقصك يعمري💃💃   {user.username}")

    elif "Dance" in message:
      await self.highrise.chat(f"💃💃{user.username}")

    elif "نسبه" in message:
      await self.highrise.chat(f"يا اهبل اكتب نسبة مو نسبه   {user.username}")

    elif "بلاك" in message:
      await self.highrise.react("heart", user.id)
      await self.highrise.react("heart", user.id)
      await self.highrise.react("heart", user.id)
      await self.highrise.react("heart", user.id)
    ...
    elif "Do you love me" in message:

      await self.highrise.chat(f"yes❤️  {user.username}")
      await self.highrise.react("heart", user.id)
      await self.highrise.react("heart", user.id)
      await self.highrise.react("heart", user.id)
      await self.highrise.react("heart", user.id)
    ...
    if message.startswith("I love you"):
      await self.highrise.react("wink", user.id)
      await self.highrise.chat(f" I love you too❤️ {user.username}")
   
    if message.startswith("."):
      target_username = message.split("@")[-1].strip()
      if target_username not in ["Mr_Black.7", "__unknwn__"]:
        await self.teleport_user_next_to(target_username, user)

    if message.startswith(("اسحب","جيبلي")):
      user_privileges = await self.highrise.get_room_privilege(user.id)
      if (user_privileges.moderator) or (user.username in ["Mr_Black.7","Y_o_u_ss_e_f"]):
       target_username = message.split("@")[-1].strip()
       if target_username not in ["Mr_Black.7"]:
          await self.teleport_user_next_to(target_username, user)
    ...
    if message.startswith("Loop") and not self.is_dancing:
      ...
      if dance_emote:
        ...
        await self.highrise.chat("The number is invalid")
    ...
    if message.startswith("gold"):
      try:
        ...
        return
      if user.username in ["Mr_Black.7", "charleykiss"]:
    ...
    if message.startswith("move"):
      room_dictionary = {
          "room_1": "<65f48cf833db0ef9b00b5378>",
          "room_2": "<>",
      }
      if user.username != "Mr_Black.7":
    ...
    if message.lower().startswith("/voiceremove "):
      try:
        ...
        await self.highrise.chat(
            "Invalid command, please use /voiceremove <username>")
        return
    ...
    if message.lstrip().startswith("add"):
      if user.username.lower() in ["Mr_Black.7", "b280_"]:
        response = await self.highrise.get_room_users()
        ...
        if len(args) < 2:
          await self.highrise.send_whisper(user.id,
                                           "Use: Command > Name > Place ")
          return
        elif args[0][0] != "@":
          await self.highrise.send_whisper(user.id,
                                           f" Incorrect format  '@username'.")
          return
        elif args[0][1:].lower() not in usernames:
          await self.highrise.send_whisper(user.id,
                                           f"{args[0][1:]}Not in the room.")
          return
      ...
      if message.startswith("ارقص") and user.username == "Mr_Black.7":
        try:
          await self.highrise.send_emote(
              random.choice([
                  
               "emote-ghost-idle" , "Tiktok2"
              ]))
        except Exception as e:
          print(f"Error: {e}")
    if message.lower().startswith("gfs"):
      await self.highrise.set_outfit(outfit=[
          ...
          Item(type='clothing',
               amount=1,
               id='eyebrow-n_basic2018newbrows17',
               account_bound=False,
               active_palette=1),
          Item(type='clothing',
               amount=41,
               id='mouth-basic2018vampteeth',
               account_bound=False,
               active_palette=41),
          Item(
              type='clothing',
              amount=1,
              id='nose-n_basic2018newnose20',
          ),
          Item(type='clothing',
               amount=3,
          ...
          Item(type='clothing',
               amount=1,
               id='shoes-n_room32019socksneakersblack',
               account_bound=False,
               active_palette=-1),
          Item(type='clothing',
               amount=15,
               id='eye-n_basic2018maleround',
               account_bound=False,
               active_palette=15),
          Item(type='clothing',
               amount=1,
    ...
    if message.lower().startswith("/getoutf"):
  ...
  async def on_message(self, user_id: str, conversation_id: str,
    ...
    if message == "You got a tip!":
      await self.highrise.send_message(conversation_id, "شكرا عالقولد")
  ...
  async def grant_gold_to_all(self, amount):
    ...
    if bot_amount >= total_gold:
      ...
      await self.highrise.chat("انا فقير🥺")


keep_alive()
if __name__ == "__main__":
  room_id = "661a23c6249b86137bd771b4"
  token = "7697bbed3899f1170ab73011fdd0d5cff5590d79f79b08c837f54bb3d2ddc0dc"
  bot = Highrise()
